  ...
  return (
    <div className="min-h-screen py-16">
      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        >
          <h1 className="text-4xl sm:text-5xl font-bold mb-6 tracking-tight sm:whitespace-nowrap">Membership Application</h1>
          <p className="text-xl text-muted-foreground sm:whitespace-nowrap">By joining us, you are taking the first step towards youth leadership & impact.</p>
        </motion.div>
