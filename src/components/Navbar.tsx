  ...
  const filterMenu = (
    <AnimatePresence>
      {isFilterOpen && isEventsPage && (
        <motion.div initial={{ opacity: 0, x: 34, y: -18, scale: 0.38, rotate: -4 }} animate={{ opacity: 1, x: 0, y: 0, scale: 1, rotate: 0 }} exit={{ opacity: 0, x: 26, y: -12, scale: 0.5, rotate: 2 }} transition={{ type: "spring", stiffness: 520, damping: 18, mass: 0.58 }} id="event-filter-menu" className="fixed left-3 right-3 top-[4.5rem] z-[60] max-h-[calc(100dvh-6rem)] w-auto overflow-y-auto origin-top-right rounded-[1.75rem] sm:absolute sm:left-auto sm:right-0 sm:top-[calc(100%+20px)] sm:max-h-none sm:w-[min(23rem,calc(100vw-1rem))] sm:overflow-visible border border-border/80 bg-background/95 p-5 shadow-2xl shadow-primary/10 backdrop-blur-2xl ring-1 ring-background/30 dark:bg-card/95 will-change-transform sm:p-6">
