  ...
  return (
    <form onSubmit={submit} className="rounded-3xl border border-border/70 bg-card/60 p-6 shadow-sm sm:p-8" noValidate>
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <label className="text-sm font-semibold text-foreground sm:col-span-2">What would you like to discuss?<span className="mt-2 block"><Select value={values.enquiryType} onValueChange={(value) => updateValue("enquiryType", value)}><SelectTrigger className="h-12 rounded-xl border-border/70 bg-background/70 px-4 text-sm font-normal shadow-none transition-[border-color,box-shadow] focus:border-primary/45 focus:ring-2 focus:ring-primary/10"><SelectValue /></SelectTrigger><SelectContent position="popper" className="rounded-xl border-border/70 bg-popover p-1.5 shadow-xl"><SelectItem value="Membership" className="rounded-lg py-2.5">Membership</SelectItem><SelectItem value="Sponsorship" className="rounded-lg py-2.5">Sponsorship</SelectItem><SelectItem value="Event partnership" className="rounded-lg py-2.5">Event partnership</SelectItem><SelectItem value="General enquiry" className="rounded-lg py-2.5">General enquiry</SelectItem></SelectContent></Select></span></label>
